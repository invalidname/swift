...
- ``Swift/Duration/init(secondsComponent:attosecondsComponent:)``
- ``Swift/Duration/seconds(_:)-311cx``
- ``Swift/Duration/seconds(_:)-5ifzr``
- ``Swift/Duration/milliseconds(_:)-1w328``
...
- ``Swift/Duration/components``

### Performing calculations on durations

- ``Swift/Duration/*(_:_:)-3d469``
- ``Swift/Duration/*=(_:_:)-52frh``
- ``Swift/Duration//(_:_:)-7fkmh``
