...
The method truncates fractional parts in currency strings. To match currency strings with fractional parts, use ``Swift/RegexComponent/localizedCurrency(code:locale:)`` instead.
