...
@Metadata {
  @PageImage(purpose: card, source: "AdoptingSwift6-PageImage-card.png", alt: "An orange Swift logo on an orange gradient background.")
}
...
![A screenshot of Xcode showing the Swift Compiler - Upcoming Features build settings](AdoptingSwift6-features)
...
![A screenshot of Xcode showing the Swift Compiler - Language build settings](AdoptingSwift6-language)
...
<!--
Default internal imports (SE-0409)
and Require existential any (SE-0355)
aren't turned on by default in Swift 6.
-->
