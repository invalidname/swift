...
When you pass a closure to an API, consider _when_ that closure will be called relative
...
code both _in_ your closure as well as the code _following_ your closure.
...
consideration of _when_ that closure is called. Even something as simple as printing
...
To write each line to the file, pass a closure to the ``Swift/Array/forEach(_:)``
method:
